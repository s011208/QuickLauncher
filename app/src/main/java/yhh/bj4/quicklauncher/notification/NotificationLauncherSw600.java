...
public class NotificationLauncherSw600 extends NotificationLauncher {
    ...
    public RemoteViews getGridLauncher(boolean isSmall) {
        ...
        setTitleAndIcon(0, R.id.title1, R.id.icon1, R.id.container1, rv);
        setTitleAndIcon(1, R.id.title2, R.id.icon2, R.id.container2, rv);
        setTitleAndIcon(2, R.id.title3, R.id.icon3, R.id.container3, rv);
        setTitleAndIcon(3, R.id.title4, R.id.icon4, R.id.container4, rv);
        setTitleAndIcon(4, R.id.title5, R.id.icon5, R.id.container5, rv);
        setTitleAndIcon(5, R.id.title6, R.id.icon6, R.id.container6, rv);
        if (isSmall) {
            ...
            setTitleAndIcon(6, R.id.title7, R.id.icon7, R.id.container7, rv);
            setTitleAndIcon(7, R.id.title8, R.id.icon8, R.id.container8, rv);
            setTitleAndIcon(8, R.id.title9, R.id.icon9, R.id.container9, rv);
            setTitleAndIcon(9, R.id.title10, R.id.icon10, R.id.container10, rv);
            setTitleAndIcon(10, R.id.title11, R.id.icon11, R.id.container11, rv);
            setTitleAndIcon(11, R.id.title12, R.id.icon12, R.id.container12, rv);
        }
        return rv;
    }
